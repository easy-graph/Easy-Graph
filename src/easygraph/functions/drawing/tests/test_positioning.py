...
class PositioningTest(unittest.TestCase):
    def test_random_position(self):
        ...
        self.assertListEqual(list(actual_result_one.keys()), [2, 6, 10, 15, 25])
    ...
    def test_circular_position(self):
        ...
        self.assertListEqual(list(actual_result.keys()), [2, 3, 5, 10])
    ...
    def test_kamada_kawai_layout(self):
        ...
        self.assertListEqual(list(actual_result.keys()), [2, 6, 10, 15, 25, 30])
