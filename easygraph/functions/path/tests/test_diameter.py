...
class test_diameter(unittest.TestCase):
    def setUp(self):
        ...
        self.g2.add_edges(edges, edges_attr=[{"weight": 7}, {"weight": 9}, {"weight": 14}, {"weight": 10},
                                             {"weight": 15}, {"weight": 11}, {"weight": 2}, {"weight": 6},
                                             {"weight": 9}])

        # source graph: https://static.javatpoint.com/tutorial/daa/images/dijkstra-algorithm.png
        self.g3 = eg.Graph()
        edges = [(0, 1), (0, 4), (1, 4), (1, 2), (4, 5), (4, 8), (2, 3), (2, 6), (2, 8), (5, 6), (5, 8), (3, 6), (3, 7),
                 (6, 7)]

        self.g3.add_edges(edges, edges_attr=[{"weight": 4}, {"weight": 1}, {"weight": 11}, {"weight": 8},
                                             {"weight": 1}, {"weight": 7}, {"weight": 7}, {"weight": 4},
                                             {"weight": 2}, {"weight": 2}, {"weight": 6}, {"weight": 14},
                                             {"weight": 9}, {"weight": 10}])
        self.g4 = eg.DiGraph()
        edges = [(0, 1), (1, 2), (2, 3), (3, 0), (0, 2), (1, 3), (1, 0)]
        self.g4.add_edges(edges, edges_attr=[{'weight': 1}, {'weight': 2}, {'weight': 3}, {'weight': 4},
                                             {'weight': 5}, {'weight': 6}, {'weight': 11}])
