...
class EvaluationTest(unittest.TestCase):
    ...
    def test_effective_size(self):
        ...
        self.assertEqual(
            eg.effective_size(test_graph, test_four_nodes, test_four_weight, test_four_n_workers),
    ...
    def test_constraint(self):
        ...
        self.assertEqual(
            eg.constraint(test_one_graph, test_one_nodes, test_one_weight, test_one_n_workers),
            test_one_expected_result
        )
        ...
        self.assertEqual(
            eg.constraint(test_two_graph, test_two_nodes, test_two_weight, test_two_n_workers),
            test_two_expected_result
        )
