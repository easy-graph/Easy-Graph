...
if __name__ == "__main__":
    ...
    plt.savefig("figs/dw_citeseer.pdf", bbox_inches="tight") # save embeddings if needed
    ...
    model = eg.SDNE(g, node_size=len(g.nodes), nhid0=256, nhid1=32, dropout=0.025, alpha=5e-4, beta=10)
