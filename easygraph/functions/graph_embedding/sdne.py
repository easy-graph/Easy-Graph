...
def parse_args():
    ...
    parser.add_argument('--output', default='node.emb',
...
class SDNE(nn.Module):
    ...
    nhid0: Size of hidden0 layer
    nhid1: Size of hidden1 layer
    dropout: float
    alpha: one training parameter
    graph=g # g:easygraph.Graph or easygraph.DiGraph
    ...
    >>> adj, node = get_adj(g) # g: easygraph.Graph or easygraph.DiGraph
    >>> model = SDNE(node, 
    ...         nhid0, 
    ...         nhid1, 
    ...         dropout, 
    ...
    References
    ----------
    .. [1] https://www.kdd.org/kdd2016/papers/files/rfp0191-wangAemb.pdf
