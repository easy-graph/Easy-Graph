...
class LPATest(unittest.TestCase):
    ...
    def test_SLPA(self):
        ...
        slpa_actual_result = self._get_sorted_values_from_dict(eg.SLPA(test_graph, 20, 0.05))
    ...
    def test_HANP(self):
        ...
        hanp_actual_result = self._get_sorted_values_from_dict(eg.HANP(test_graph, 0.1, 0.1))
    ...
    def test_BMLPA(self):
        ...
        bmlpa_actual_result = self._get_sorted_values_from_dict(eg.BMLPA(test_graph, 0.1))
