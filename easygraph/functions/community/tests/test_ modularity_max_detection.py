...
class ModularityMaxDetectionTest(unittest.TestCase):
    ...
    def test_greedy_modularity_communities_digraph(self):
        ...
        test_graph_three_actual_result = eg.greedy_modularity_communities(test_graph_three)
        test_graph_three_expected_result = [frozenset({'A'}), frozenset({'B'})]
        self.assertEqual(test_graph_three_actual_result, test_graph_three_expected_result)
