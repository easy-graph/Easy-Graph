...
class BiConnectedTest(unittest.TestCase):
    ...
    def test_generator_biconnected_components_nodes(self):
        ...
        actual_result = [_ for _ in eg.generator_biconnected_components_nodes(test_graph)]
    ...
    def test_generator_biconnected_components_edges(self):
        ...
        actual_result = [_ for _ in eg.generator_biconnected_components_edges(test_graph)]
