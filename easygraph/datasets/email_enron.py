...
class Email_Enron(EasyGraphDataset):
    ...
    def load(self):
        ...
        # self._g = dict_to_hypergraph(self.load_data,is_dynamic=True)
    ...
    def process(self):
        ...
        # root = self.raw_dir
        # self.load_data = None
        # with open(os.path.join(root, self.save_name + ".json"), 'r') as f:
        #     self.load_data = json.load(f)
        print("process")
        ...
        self._g.ndata["hyperedge_feature"] = tensor(range(1, len(edge_feature_list)))
