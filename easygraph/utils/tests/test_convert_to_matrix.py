...
class ConvertToMatrix(unittest.TestCase):
    ...
    def test_from_numpy_array(self):
        ...
        parallel_edges_graph = eg.from_numpy_array(test_array, parallel_edges=True, create_using=eg.MultiGraph)
        expected_return = [
            tuple((0, 0, {'weight': 1})),
            tuple((0, 1, {'weight': 2})),
            tuple((1, 1, {'weight': 1}))
        ...
        self.assertEqual(test_multigraph.edges, multigraph_and_parallel_edges_expected_return)
        self.assertEqual(parallel_edges_graph.edges, multigraph_and_parallel_edges_expected_return)
        self.assertEqual(graph_with_data_types.edges, array_with_data_types_expected_return)
    ...
    def test_to_numpy_array(self):
        ...
        multi_di_graph_test_array = eg.to_numpy_array(test_multi_di_graph, nodelist=[0, 1, 2]).tolist()
    ...
    def test_from_pandas_adjacency(self):
        ...
        test_edges_expected_return = [(0, 0, {'weight': 1}), (0, 1, {'weight': 2}), (1, 1, {'weight': 1})]
    ...
    def test_from_pandas_edgelist(self):
        ...
        df[0] = a
        df["b"] = b
        pandas_edge_list_graph = eg.from_pandas_edgelist(df, 0, "b", ["test_col_one", "test_col_two"])
        ...
        self.assertEqual(pandas_edge_list_graph.edges, pandas_edge_list_graph_edges_expected_return)
        self.assertEqual(pandas_edge_list_graph.nodes, pandas_edge_list_graph_nodes_expected_return)
        self.assertEqual(pandas_edge_list_graph.adj, pandas_edge_list_graph_adj_expected_return)
    ...
    def test_from_scipy_sparse_matrix(self):
        ...
        self.assertEqual(test_graph.nodes, from_scipy_sparse_matrix_nodes_expected_return)
        self.assertEqual(test_graph.edges, from_scipy_sparse_matrix_edges_expected_return)
    ...
    def test_from_scipy_sparse_array(self):
        ...
        test_array = sp.sparse.csr_array((test_data, (test_rows, test_cols)), shape=(3, 3))
        test_graph = eg.from_scipy_sparse_array(test_array)

        from_scipy_sparse_array_nodes_expected_return = {
            0: {},
            1: {},
            2: {}
        }
        ...
        self.assertEqual(test_graph.nodes, from_scipy_sparse_array_nodes_expected_return)
        self.assertEqual(test_graph.edges, from_scipy_sparse_array_edges_expected_return)
