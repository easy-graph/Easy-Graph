...
PYBIND11_MODULE(cpp_easygraph, m) {
  ...
  py::class_<Graph>(m, "Graph")
      ...
      .def("add_nodes", &Graph_add_nodes, py::arg("nodes_for_adding"),
           py::arg("nodes_attr") = py::list())
      ...
      .def("add_edges", &Graph_add_edges, py::arg("edges_for_adding"),
           py::arg("edges_attr") = py::list())
      .def("add_edges_from", &Graph_add_edges_from)
      .def("add_edges_from_file", &Graph_add_edges_from_file, py::arg("file"),
           py::arg("weighted") = false)
      .def("add_weighted_edge", &Graph_add_weighted_edge, py::arg("u_of_edge"),
           py::arg("v_of_edge"), py::arg("weight"))
      .def("remove_edge", &Graph_remove_edge, py::arg("u"), py::arg("v"))
      .def("remove_edges", &Graph_remove_edges, py::arg("edges_to_remove"))
      .def("number_of_edges", &Graph_number_of_edges, py::arg("u") = py::none(),
           py::arg("v") = py::none())
      .def("has_edge", &Graph_has_edge, py::arg("u"), py::arg("y"))
      .def("copy", &Graph_copy)
      .def("degree", &Graph_degree, py::arg("weight") = py::str("weight"))
      ...
      .def_property_readonly("graph", &Graph::get_graph)
      .def_property_readonly("nodes", &Graph::get_nodes)
      .def_property_readonly("name", &Graph::get_name)
      .def_property_readonly("adj", &Graph::get_adj)
  ...
  py::class_<DiGraph, Graph>(m, "DiGraph")
      ...
      .def("number_of_edges", &DiGraph_number_of_edges,
           py::arg("u") = py::none(), py::arg("v") = py::none());

  m.def("cpp_density", &density, py::arg("G"));
  m.def("cpp_constraint", &constraint, py::arg("G"),
        py::arg("nodes") = py::none(), py::arg("weight") = py::none(),
        py::arg("n_workers") = py::none());
  m.def("cpp_effective_size", &effective_size, py::arg("G"),
        py::arg("nodes") = py::none(), py::arg("weight") = py::none(),
        py::arg("n_workers") = py::none());
  m.def("cpp_hierarchy", &hierarchy, py::arg("G"),
        py::arg("nodes") = py::none(), py::arg("weight") = py::none(),
        py::arg("n_workers") = py::none());
  m.def("cpp_dijkstra_multisource", &_dijkstra_multisource, py::arg("G"),
        py::arg("sources"), py::arg("weight") = "weight",
        py::arg("target") = py::none());
  m.def("cpp_clustering", &clustering, py::arg("G"),
        py::arg("nodes") = py::none(), py::arg("weight") = py::none());
  m.def("cpp_biconnected_dfs_record_edges", &_biconnected_dfs_record_edges,
        py::arg("G"), py::arg("need_components") = true);
