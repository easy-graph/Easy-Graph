...
PYBIND11_MODULE(cpp_easygraph, m) {
    ...
    m.def("cpp_betweenness_centrality", &betweenness_centrality, py::arg("G"), py::arg("k") = py::none(), py::arg("weight") = "weight", py::arg("cutoff") = py::none(),py::arg("sources") = py::none(), py::arg("normalized") = py::bool_(true), py::arg("endpoints") = py::bool_(false), py::arg("seed") = py::none());
